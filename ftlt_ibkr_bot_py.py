...
Original file is located at
    https://colab.research.google.com/drive/153APMi2M_BYcG8ALAOCZ5wl63uye3S9d
"""
...
pip install ib-insync pandas numpy python-dateutil pytz
Also run IB Gateway (or TWS) on the VPS and enable API:

Configure → API → Settings → ✅ Enable ActiveX and Socket Clients

Paper trading default port = 7497 (live = 7496
"""